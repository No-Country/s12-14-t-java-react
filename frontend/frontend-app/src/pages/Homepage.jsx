  ...
  return (
    <section className='min-h-screen bg-purple'>
      <div className='grid gap-4 md:grid-cols-2'>
        ...
        <div className='col-auto px-4 py-5 md:h-screen'>
          <img src='/img/img_vehicle.svg' alt='' />
          <form className='block py-5 space-y-3 text-center'>
            <div className='flex flex-col gap-5'>
              <input type='text' placeholder='Ingrese su correo' className='border-none rounded-lg' />
              <input type='password' placeholder='Ingrese su contraseña' className='border-none rounded-lg ' />
            </div>
