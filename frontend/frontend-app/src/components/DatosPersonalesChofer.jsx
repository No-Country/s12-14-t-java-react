...
function DatosPersonalesChofer() {
    ...
    return (
        ...
        <section>
            ...
            <button className="w-[75%] text-center mt-10 ml-6 text-[#31429B] font-semibold text-base">Carga tus datos laborales para completar tu perfil</button>
            ...
            <button
                className={`ml-6 mt-40 text-center w-72 h-10 rounded ${Name2 ? 'bg-blue-600' : 'bg-gray'
                    } text-white text-sm`}
            >
                Guardar información
            </button>
