      ...
      <section className='new-profile-continer shadow-custom'>
        <div className='continer-empleado-vehiculooff  text-[#0D1544]'>
          <form className='form' onSubmit={handleSubmit}>
            <div className='container-form'>
              ...
              <div className='section-2-form mt-3'>
                <div className='mx-auto max-w-xs mt-3'>
                  <label htmlFor='photo' className='mb-1 block text-xl font-medium text-gray-700'>
                    Foto del empleado*
                  </label>
                  <input
                    onChange={handleChange}
            ...
            <button
              type='submit'
              className='rounded-lg border bg-dark-blue border-bg-blue-500 bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-blue-700 hover:bg-blue-700 focus:ring focus:ring-blue-200 disabled:cursor-not-allowed disabled:border-blue-300 disabled:bg-blue-300'
            >
