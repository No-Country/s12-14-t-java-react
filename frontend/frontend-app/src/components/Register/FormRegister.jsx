...
const FormRegister=()=>{
    ...
    return (
        ...
        className="text-blue flex flex-col justify-center items-center mb-16">
            ...
            {
                errors.companyName && <span className='text-[18px] text-[#6a3838] font-bold'>
            ...
            src={iconError}/> :<img className='icon-input w-6 h-6 ' src={iconCheck}/>):<></>}
                ...
                />
                        ...
                        {
                errors.name && <span className='text-[18px] text-[#6a3838] font-bold'>
                    {errors.name.message}
                </span>
            }
            <label 
            ...
            {
                selected=='lastName'?
               ( errors.lastName? <img className='icon-input w-8 h-8'
            src={iconError}/>:<img className='icon-input w-6 h-6 ' src={iconCheck}/>):<></>}
                ...
                />
                        ...
                        {
                errors.lastName && <span className='text-[18px] text-[#6a3838] font-bold'>
            ...
            src={iconError}/> :<img className='icon-input w-6 h-6 ' src={iconCheck}/>):<></>}
                ...
                errors.email && <span className='text-[18px] text-[#6a3838] font-bold'>
